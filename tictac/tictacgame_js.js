$(document).ready(function () {
    ...
    function logicWin(){
        ...
        $("#imge3").attr("src") && $("#imge6").attr("src") && $("#imge9").attr("src") == "image_x.png" ||
        $("#imge1").attr("src") && $("#imge4").attr("src") && $("#imge7").attr("src") == "image_x.png" ||
        $("#imge2").attr("src") && $("#imge5").attr("src") && $("#imge8").attr("src") == "image_x.png" 
        ){
        ...
        $("#imge3").attr("src") && $("#imge6").attr("src") && $("#imge9").attr("src") == "image_o.png" ||
        $("#imge1").attr("src") && $("#imge4").attr("src") && $("#imge7").attr("src") == "image_o.png" ||
        $("#imge2").attr("src") && $("#imge5").attr("src") && $("#imge8").attr("src") == "image_o.png" 
        ){
            $(".bottom_div1").show("fast");
